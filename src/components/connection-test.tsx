...
function ConnectionTest() {
    ...
    const bank_public_key = "044e3b81af9c2234cad09d679ce6035ed1392347ce64ce405f5dcd36228a25de6e47fd35c4215d1edf53e6f83de344615ce719bdb0fd878f6ed76f06dd277956de"
    ...
    const submitBid = async () => {
        ...
        const bidReceipt = await invoke<string>('handle_bid_details', bidDetails);
        setReceipt(bidReceipt)
